# Generated by Django 3.2.15 on 2022-08-21 04:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hardcopy_requested', models.BooleanField(default=False)),
            ],
        ),
        migrations.CreateModel(
            name='Institute',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('18', 'B.E/B.Tech in Biotechnology Engineering'), ('28', 'B.E/B.Tech in Metallurgy Engineering'), ('22', 'B.E/B.Tech in Agricultural Engineering'), ('10', 'B.E/B.Tech in Electronics and Telecommunication Engineering'), ('7', 'B.E/B.Tech in Information Technology'), ('36', 'B.E / B.Tech in Nuclear Engineering'), ('8', 'B.E/B.Tech in Instrumentation and Control Engineering'), ('23', 'B.E/B.Tech in Environmental Engineering'), ('35', 'B.E/B.Tech in Geotechnical Engineering'), ('14', 'B.E/B.Tech in Automobile Engineering'), ('21', 'B.E/B.Tech in Food Processing and Technology'), ('29', 'B.E/B.Tech in Textile Engineering'), ('17', 'B.E/B.Tech in Production Engineering'), ('26', 'B.E/B.Tech in Infrastructure Engineering'), ('32', 'B.E/B.Tech in Geoinformatics'), ('12', 'B.E/B.Tech in Aeronautical Engineering'), ('19', 'B.E/B.Tech in Genetic Engineering'), ('27', 'B.E/B.Tech in Motorsport Engineering'), ('4', 'B.E/B.Tech in Electrical and Electronics Engineering'), ('33', 'B.E/B.Tech in Petrochemical Engineering'), ('11', 'B.E/B.Tech in Petroleum Engineering'), ('1', 'B.E/B.Tech in Mechanical Engineering'), ('6', 'B.E/B.Tech in Chemical Engineering'), ('9', 'B.E/B.Tech in Electronics Engineering'), ('13', 'B.E/B.Tech in Aerospace Engineering'), ('30', 'B.E/B.Tech in Marine Engineering'), ('3', 'B.E/B.Tech in Electrical Engineering'), ('25', 'B.E/B.Tech in Agricultural Information Technology'), ('24', 'B.E/B.Tech in Dairy Technology and Engineering'), ('31', 'B.E/B.Tech in Naval Architecture'), ('20', 'B.E/B.Tech in Plastics Engineering'), ('2', 'B.E/B.Tech in Electronics and Communication Engineering'), ('16', 'B.E/B.Tech in Power Engineering'), ('5', 'B.E/B.Tech in Civil Engineering'), ('34', 'B.E/B.Tech in Polymer Engineering'), ('15', 'B.E/B.Tech in Mining Engineering'), ('0', 'B.E/B.Tech in Computer Science Engineering')], default='0', max_length=255)),
